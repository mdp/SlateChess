...
function InterfaceWidget.new(_self, opts)
    ...
    return setmetatable({
        ...
        changes = {
            ...
            previous_move_hints = init.previous_move_hints ~= false,
...
function InterfaceWidget:buildOptions()
    ...
    self.optionsGroup = VerticalGroup:new{
        ...
        self:makeToggle("learning_mode", _("Show Valid Moves")),
        VerticalSpan:new{ width = Size.padding.small },
        self:makeToggle("opponent_hints", _("Show Opponent's Moves")),
        VerticalSpan:new{ width = Size.padding.small },
        self:makeToggle("previous_move_hints", _("Highlight Last Move")),
        VerticalSpan:new{ width = Size.padding.small },
...
function InterfaceWidget:applyPreview()
    ...
    -- them so the toggle previews immediately.
    if self.parent and self.parent.updateNotation then
        self.parent:updateNotation()
    end
